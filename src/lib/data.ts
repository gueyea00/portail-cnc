...
export interface Article {
  ...
  contenu: string;
  date: string;
  categorie: "decision" | "communique" | "enquete" | "evenement";
  image?: string;
}
...
export const decisions: Decision[] = [
  { reference: "CNC/DEC/2024/001", date: "2024-03-15", objet: "Entente sur les prix dans le secteur des télécommunications", secteur: "Télécommunications", type: "decision" },
  { reference: "CNC/DEC/2024/002", date: "2024-04-22", objet: "Abus de position dominante — marché du ciment", secteur: "BTP / Matériaux", type: "sanction" },
  { reference: "CNC/AVI/2024/003", date: "2024-05-10", objet: "Avis sur le projet de loi relatif à la distribution pétrolière", secteur: "Hydrocarbures", type: "avis" },
  { reference: "CNC/DEC/2024/004", date: "2024-06-18", objet: "Concentration — acquisition de TchadNet par AfricaTel", secteur: "Télécommunications", type: "decision" },
  { reference: "CNC/DEC/2024/005", date: "2024-07-05", objet: "Pratiques commerciales déloyales — secteur agroalimentaire", secteur: "Agroalimentaire", type: "sanction" },
  { reference: "CNC/AVI/2024/006", date: "2024-08-20", objet: "Avis sur les conditions de concurrence dans le transport aérien", secteur: "Transport", type: "avis" },
  { reference: "CNC/DEC/2024/007", date: "2024-09-12", objet: "Entente sur la répartition des marchés — secteur pharmaceutique", secteur: "Santé", type: "decision" },
  { reference: "CNC/DEC/2025/001", date: "2025-01-15", objet: "Sanction pour entente illicite — opérateurs télécom", secteur: "Télécommunications", type: "sanction" },
  { reference: "CNC/DEC/2025/002", date: "2025-02-28", objet: "Pratiques de prix prédateurs — marché du sucre", secteur: "Agroalimentaire", type: "decision" },
  { reference: "CNC/AVI/2025/003", date: "2025-03-10", objet: "Avis sur la régulation du commerce électronique", secteur: "Commerce", type: "avis" },
];
...
export const documents: DocumentCNC[] = [
  ...
  { titre: "Décision CNC/DEC/2024/001 — Entente télécom", categorie: "Décisions", date: "2024-03-15", taille: "2.1 Mo", type: "PDF" },
  { titre: "Décision CNC/DEC/2024/002 — Abus de position ciment", categorie: "Décisions", date: "2024-04-22", taille: "1.8 Mo", type: "PDF" },
...
export const membres: Membre[] = [
  { nom: "M. Ibrahim Mahamat Saleh", fonction: "Président du Conseil", initiales: "IM", couleur: "bg-primary" },
...
export const galerieItems: GalerieItem[] = [
  { id: 1, titre: "Réunion plénière du Conseil", description: "Session plénière ordinaire du Conseil National de la Concurrence", date: "2025-01-20", categorie: "Réunions du Conseil", gradient: "from-[#003F8A] to-[#0066CC]" },
  ...
  { id: 3, titre: "Cérémonie de partenariat institutionnel", description: "Signature de convention avec la CEMAC", date: "2025-03-01", categorie: "Partenariats", gradient: "from-[#1E3A5F] to-[#003F8A]" },
  ...
  { id: 5, titre: "Forum régional CEMAC 2024", description: "Participation au forum sur la concurrence en zone CEMAC", date: "2024-11-15", categorie: "Événements", gradient: "from-[#D4A017] to-[#003F8A]" },
  { id: 6, titre: "Rencontre avec les opérateurs économiques", description: "Dialogue avec les acteurs du secteur privé", date: "2025-01-10", categorie: "Partenariats", gradient: "from-[#1E3A5F] to-[#003F8A]" },
  { id: 7, titre: "Assemblée générale du CNC 2024", description: "Bilan annuel et perspectives", date: "2024-12-20", categorie: "Réunions du Conseil", gradient: "from-[#003F8A] to-[#0066CC]" },
  ...
  { id: 9, titre: "Visite du Ministre du Commerce", description: "Accueil du Ministre du Commerce au siège du CNC", date: "2025-01-25", categorie: "Événements", gradient: "from-[#D4A017] to-[#003F8A]" },
  { id: 10, titre: "Audience avec les associations de consommateurs", description: "Échange avec les représentants des consommateurs", date: "2025-03-05", categorie: "Partenariats", gradient: "from-[#1E3A5F] to-[#003F8A]" },
  { id: 11, titre: "Session extraordinaire du Conseil", description: "Réunion extraordinaire sur le secteur pétrolier", date: "2025-02-10", categorie: "Réunions du Conseil", gradient: "from-[#003F8A] to-[#0066CC]" },
  ...
  { id: 13, titre: "Conférence de presse — bilan 2024", description: "Présentation des résultats annuels à la presse", date: "2025-01-30", categorie: "Événements", gradient: "from-[#D4A017] to-[#003F8A]" },
  ...
  { id: 15, titre: "Rencontre CNC — Banque Centrale", description: "Coopération sur la régulation du secteur bancaire", date: "2025-02-28", categorie: "Partenariats", gradient: "from-[#1E3A5F] to-[#003F8A]" },
  ...
  { id: 17, titre: "Journée portes ouvertes CNC", description: "Accueil du public au siège du CNC", date: "2024-09-20", categorie: "Événements", gradient: "from-[#D4A017] to-[#003F8A]" },
  ...
  { id: 19, titre: "Délibération du Conseil — secteur BTP", description: "Examen des dossiers du secteur BTP", date: "2025-02-25", categorie: "Réunions du Conseil", gradient: "from-[#003F8A] to-[#0066CC]" },
...
export const services = [
  ...
  { titre: "Accès à la jurisprudence", description: "Consultez l'ensemble des décisions rendues par le Conseil, classées par secteur et par année.", icone: "BookOpen", lien: "/decisions" },
...
export const stats = [
  ...
  { valeur: "12", label: "Décisions rendues" },
