      ...
      <div className="container-page py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            {/* Card 1 */}
            <div className="bg-background rounded-2xl p-8 border border-border hover:shadow-xl hover:border-primary/30 transition-all duration-300 group">
            ...
            {/* Card 3 */}
            <div className="bg-background rounded-2xl p-8 border border-border hover:shadow-xl hover:border-primary/30 transition-all duration-300 group md:col-span-2">
              <div className="w-14 h-14 bg-primary/10 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
