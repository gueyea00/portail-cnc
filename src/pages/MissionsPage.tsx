        ...
        <div className="container-page">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {(missionsApi.length > 0 ? missionsApi : []).map((m: any, i: number) => (
              <FadeIn key={m.titre} delay={i * 100} className="h-full">
                <div className="h-full bg-surface p-6 rounded-[2rem] shadow-soft flex flex-col items-center text-center border-2 border-transparent hover:border-primary/20 hover:shadow-xl transition-all duration-300 group">
        ...
        <div className="container-page">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 relative">
            ...
            {sortedEtapes.length === 0 ? (
              ...
              <FadeIn key={e.id} delay={idx * 150} className="z-10 h-full">
                <div className="h-full relative bg-surface p-6 rounded-2xl border border-border flex flex-col items-center text-center hover:shadow-lg transition-all">
