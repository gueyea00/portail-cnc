  ...
  return (
    <div className="container-page py-12 max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold mb-8 flex items-center gap-3">
        <MessageSquareWarning className="text-primary" /> Déposer une plainte ou une déclaration
      </h1>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div><label className={labelClass}>Qualité (ex: gérant, client) *</label><input {...form.register("qualite")} className={inputClass} /></div>
        ...
        <div><label className={labelClass}>Adresse complète *</label><input {...form.register("adresse")} className={inputClass} /></div>
        <div><label className={labelClass}>Objet de la demande *</label><input {...form.register("objet")} className={inputClass} /></div>
        <div>
