...
import { MapPin, Phone, Mail, Clock, Loader2, Facebook, Linkedin, Twitter } from "lucide-react";
    ...
    <div>
      <section className="page-hero">
        <div className="container-page">
          <h1 className="text-3xl md:text-4xl font-bold">Contact & Accès</h1>
      ...
      <div className="container-page py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-primary/5 to-secondary/5 rounded-lg border border-border h-64 flex items-center justify-center">
